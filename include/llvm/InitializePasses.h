...
void initializeAsapCoveragePassPass(PassRegistry&);
void initializeAsapGcovPassPass(PassRegistry&);
...
void initializeSanityCheckCoverageCostPass(PassRegistry&);
void initializeSanityCheckGcovCostPass(PassRegistry&);
