...
build_asap_initial "bzip2" "tsan"     "configure_and_build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
...
build_asap_coverage "bzip2" "tsan"  "build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
...
build_asap_optimized "bzip2" "tsan" "s0000" "-asap-sanity-level=0.000" "build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
build_asap_optimized "bzip2" "tsan" "c0010" "-asap-cost-level=0.010" "build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
build_asap_optimized "bzip2" "tsan" "c0040" "-asap-cost-level=0.040" "build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
build_asap_optimized "bzip2" "tsan" "c1000" "-asap-cost-level=1.000" "build_bzip2" "$TSAN_CFLAGS" "$TSAN_LDFLAGS"
